...
{
    public class MousepadFilterExpressionFactory : IMousepadFilterExpressionFactory
    {
        ...
        private void AddBottomMaterialConstraint(ref Expression<Func<Mousepad, bool>> expression, ICollection<string> bottomMaterials)
        {
        ...
        private void AddTopMaterialConstraint(ref Expression<Func<Mousepad, bool>> expression, ICollection<string> topMaterials)
        {
